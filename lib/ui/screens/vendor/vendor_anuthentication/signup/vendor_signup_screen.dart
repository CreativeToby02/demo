...
class VendorSignupScreen extends StatefulWidget {
  static const String name = 'vendor-signup';
  static const String route = '/vendor-signup';
  const VendorSignupScreen({super.key, this.onTap});
    ...
    if (_usernameController.text == '') {
      ...
      try {
        ...
        if (newUser != null) {
          ...
          GoRouter.of(context).push(VendorBottomNavigator.route);
        }
